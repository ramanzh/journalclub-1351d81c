...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ژورنال معاملاتی | TradeJournal" },
      { name: "description", content: "ژورنال معاملاتی حرفه‌ای فارسی برای معامله‌گران فارکس، کریپتو و سهام." },
      { property: "og:title", content: "ژورنال معاملاتی فارسی" },
      { property: "og:description", content: "ثبت معاملات، تحلیل احساسات و آمار حرفه‌ای." },
