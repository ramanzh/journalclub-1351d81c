...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ژورنال کلاب حرفه ای برای تریدر های فارسی زبان در سرتاسر دنیا" },
      { property: "og:title", content: "Journalclub ||  ژورنال کلاب" },
      { property: "og:description", content: "ژورنال کلاب حرفه ای برای تریدر های فارسی زبان در سرتاسر دنیا" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Journalclub ||  ژورنال کلاب" },
      { name: "twitter:description", content: "ژورنال کلاب حرفه ای برای تریدر های فارسی زبان در سرتاسر دنیا" },
